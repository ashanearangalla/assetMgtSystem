...
if ($isEditMode) {
    $stmt = $conn->prepare("SELECT c.consumableID, 
i.name, 
i.image, 
i.notes, 
...
LEFT JOIN office o ON i.officeID = o.officeID WHERE consumableID = ?");
...
<main class="main-content-create">
    ...
    <div class="form-container">
        <div class="form-body">
            <form id="consumableForm" action="db_context.php" method="POST" enctype="multipart/form-data" onsubmit="return validateConsumableForm()">
                ...
                <div class="form-element">
                    ...
                    <input type="text" id="consumableName" name="consumableName" placeholder="Consumable Name" value="<?php echo htmlspecialchars($name); ?>">
                </div>
...
<script>
    ...
    function validateConsumableForm() {
        ...
        if (!consumableName) {
            errorBox.innerHTML = "Consumable Name is required.";
            return false;
        }
        if (!status) {
